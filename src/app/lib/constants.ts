...
// [신규] 배포한 Hall of Fame 컨트랙트 주소 (여기에 붙여넣으세요)
export const HOF_CONTRACT_ADDRESS = '0x99190F6633a27423709fFc4C893A7d1106906C7E'
...
// [신규] Hall of Fame ABI
export const HOF_ABI = [
  'function register(address _instance, string memory _message) external',
  'function getAllWinners() external view returns (tuple(address hacker, uint256 timestamp, string message)[])',
  'function hasRegistered(address hacker) external view returns (bool)',
]
